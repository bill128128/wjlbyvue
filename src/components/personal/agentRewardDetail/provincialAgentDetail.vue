	...
	export default{
		...
		data(){
			return{
				...
				pnum : 9,
				dataVal:new Date(),
				agentType:1, //状态，1：省，2：市，3：县，4：平级
				handler:function(e){e.preventDefault();},
				info:{
					type:1,
					timer:this.changeDataVal
				},
				bottomDistance:150,
			}
		},
		...
		methods:{
            ...
            closeTouch:function(){        
                document.getElementById("provincialAgentDetail").addEventListener('touchmove',this.handler,{passive:false}); //阻止默认事件   
            },    
            openTouch:function(){        
                document.getElementById("provincialAgentDetail").removeEventListener('touchmove', this.handler,{passive:false}); //打开默认事件     
            },
            openPicker(){
