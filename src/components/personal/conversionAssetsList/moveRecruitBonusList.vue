...
<script>
	import select1 from './inandout/moveRecruitBonusListin'
	import select2 from './inandout/moveRecruitBonusListout'
	export default{
		name:'moveRecruitBonusList',
		data(){
			return{
				button:['转入','转出'],
                activeButton:0,
