<template>
	<div id="recruitScoreAndRecruitBonus">
        ...
        <form action="">
            <div>
                ...
                <div class="selected" v-show="!isShowleaseIntegral">
                    <div class="placeholder">招募红利：{{info.leaseIntegralCount - info.frozenScore}}
                    </div>
                </div>
            </div>
            <div class="tip">招募积分需大于或等于您所选兑充金额的50%，且为100的整数倍。</div>
...
<script>
	export default{
		name:'recruitScoreAndRecruitBonus',
		data(){
			return{
		...
		computed:{
			frozen_score(){
				return this.$store.state.recruit.frozen_score;
			},
			blush_score(){
