	...
	<div id="rejected">
		<ul class="trade_list_menu">
            <li class="item">
                <ul class="infomation">
                    <li>
                        <p class="count">4b0012</p>
                        <p class="text">代码</p>
                    </li>
                    <li>
                        <p class="count">Liping</p>
                        <p class="text">委托人</p>
                    </li>
                    <li>
                        <p class="count">1111bo</p>
                        <p class="text">开盘价</p>
                    </li>
                    <li>
                        <p class="count">1111bo</p>
                ...
                <ul class="trade_time">
                    <li class="time">2018.08.10  09.20</li>
                    <li class="status">
                        <button class="status_action">成交</button>
                    </li>
                </ul>
            </li>
        </ul>
...
<style scoped>
    ...
    form .submit{ width:3.2rem; height:0.96rem; }
    .count_input{
