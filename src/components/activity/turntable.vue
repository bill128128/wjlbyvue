<template>
	<div id="trunplate">
		...
		<div class="container">
			...
			<div class="popup" v-show="toast_control" @click="toast_control=false">
				<div class="popbg"></div>
				<div class="popbox">
			...
			chou() {
				...
				if(_this.count == 1){
					...
					if(_this.winnum == 7){
						...
						//alert(_this.winnum);
						console.log('winnum:'+_this.winnum);
						console.log('nums:'+_this.nums);
			...
			getwinnum(){
				this.$store.dispatch('turnplate/getresult').then(()=>{
					if(this.$store.state.turnplate.code == 200){
						...
						console.log('gangwinnum:'+ this.winnum);
